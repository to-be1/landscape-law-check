...
print_law_row("3. 부대시설", "통학버스 정류장", bus_formula_text, law_bus_stop, bus_val_str, bus_pass)
...
print_law_row("3. 부대시설", "텃밭 / 부속정원", "설치 권장 (녹색건축인증 및 친환경 인센티브 조례 항목)", "녹색건축인증기준 지침 가이드", f"권장 / {garden_area_plan:,.1f} ㎡", True)
